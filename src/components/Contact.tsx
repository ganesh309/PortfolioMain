    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12">
          {/* Contact Information */}
          <RevealOnScroll className="h-full" width="100%">
            <div className="p-6 sm:p-8 rounded-2xl backdrop-blur-xl border border-purple-900/20 shadow-lg hover:shadow-purple-900/40 hover:bg-[rgb(54,40,61)]/10 transition-all duration-300 h-full flex flex-col" style={{ backgroundColor: 'rgb(54 40 61 / 5%)' }}>
              ...
              <div className="space-y-4 sm:space-y-6 flex-grow">
                {contactInfo.map((info, index) => (
                  ...
                  >
                    <div className="flex-shrink-0 p-2 sm:p-3 rounded-full bg-[rgb(29,28,30)]/80 mr-4">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <a
                        href={info.link}
                        className="text-base text-white hover:text-purple-300 transition-colors duration-200 break-words"
                      >
                        {info.value}
                      </a>
                    </div>
                  ...
                  <div className="flex flex-wrap gap-4">
                    {socialLinks.map((social, index) => (
                      <a
                        ...
                        className="p-3 rounded-full bg-[#133f7a] hover:bg-[#133f7a]/90 shadow-md hover:shadow-purple-500/20 transition-all duration-300 text-purple-300 hover:text-white"
          ...
          {/* Contact Form */}
          <RevealOnScroll className="h-full" delay={0.2} width="100%">
            <div className="p-6 sm:p-8 rounded-2xl backdrop-blur-xl border border-purple-900/20 shadow-lg hover:shadow-purple-900/40 hover:bg-[rgb(54,40,61)]/10 transition-all duration-300 h-full flex flex-col" style={{ backgroundColor: 'rgb(54 40 61 / 5%)' }}>
              ...
              <form ref={formRef} onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 text-base rounded-lg border border-white/10 text-white placeholder-gray-400 focus:outline-none focus:border-[rgb(255,255,255)]/10 transition-all duration-200 hover:shadow-sm backdrop-blur-md bg-[rgb(0,0,0)]/5 hover:bg-white/5 hover:border-[rgb(255,255,255)]/10"
                ...
                <div>
                  <button
                    ...
                    className={`w-full flex items-center justify-center px-6 py-3 bg-[#133f7a] text-white font-medium rounded-lg hover:bg-[#133f7a]/90 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 transition-all duration-300 ${isSubmitting ? 'opacity-70 cursor-not-allowed' : ''}`}
                  >
                    {isSubmitting ? (
                      'Sending...'
                    ) : (
